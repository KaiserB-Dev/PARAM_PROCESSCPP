...
int main(int argc, char** argv){
    ...
    std::deque<cv::Point> centersArr2;//Arrays de prueba
    ...
    while(true){
        ...
        cv::morphologyEx(DilFrame, DilFrame, cv::MORPH_OPEN, cv::getStructuringElement(cv::MORPH_ELLIPSE,(cv::Size(8,8)))); //Dilata la imagen y luego erosiona la imagen dilatada
        //fin preprocessing
        ...
        for(int i=0; i<minEllipse.size(); ++i){
            ...
            //std::cout<<minEllipse[i].center;
                ...
                /*if(count  % 2 != 0){
                    ...
                    std::cout<<centersArr2[i]<<std::endl; //Intento de alamacenamiento de puntos.
                }else{
